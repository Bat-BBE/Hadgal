    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 pb-24 p-4">
      ...
      <div className="flex justify-between mb-6 space-x-3">
        <button 
          ...
          className="flex flex-col justify-center bg-white rounded-xl shadow-lg p-4 w-full max-w-32 h-28 hover:shadow-xl hover:scale-105 transition-all duration-300 border border-emerald-100"
        >
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-500 rounded-2xl p-5 flex items-center justify-between mb-6 text-white shadow-lg">
        <div className="flex-1">
          ...
          <button
            onClick={handleClick}
            className="bg-gradient-to-r from-white via-gray-200 to-white text-emerald-800 px-2 py-2 rounded-xl font-bold hover:bg-white flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] border border-emerald-200 shadow-sm group"
            >
            <span className="text-sm">Хуримтлал үүсгэх</span>
            <Image
                ...
                >
                  ...
                  <div className="flex flex-row justify-between space-x-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-400 transition-colors flex-1"
                    >
                      Дэлгэрэнгүй
                    </button>
                  </div>
